...
using FilmesMoura01.WebAPI.Repositories;
using Microsoft.AspNetCore.Authorization;
using Microsoft.AspNetCore.Http;
using Microsoft.AspNetCore.Mvc;
using FilmesMoura01.WebAPI.DTO;
...
public class FilmeController : ControllerBase
{
    ...
    [HttpPost]
    public async Task<IActionResult> Post([FromForm]FilmesDTO novoFilme)
    {
    ...
    public async Task<IActionResult> Put(Guid id, FilmesDTO filme)
    {
